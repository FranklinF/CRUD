Vue.component('accounts-main-component', {
    props: ['reload'],
    template: `
    <div  class="m-grid__item m-grid__item--fluid m-wrapper" id="m-accounts-main">
    
      <div class="m-content">
        <plans-component @showtoast="$emit('showtoast', $event)" :reload="reload"></plans-component>
        <!--<cards-list-component @showtoast="$emit('showtoast', $event)" :reload="reload"></cards-list-component>-->
        
      <payments-list-component :reload="reload"></payments-list-component>
      </div>
    </div>
