Vue.component('redeemcoupon-table-header-component', {
    template: `
    <div class="m-portlet__head">
        <div class="m-portlet__head-caption">
            <div class="m-portlet__head-title">
                <h3 class="m-portlet__head-text">
                   Redeemed Coupon Serials
                </h3>
            </div>
        </div>
    </div>
...
Vue.component('redeemcoupon-table-alert-component', {
    template: `
...
Vue.component('redeemcoupon-table-search-component', {
    methods: {
        displayForm : function(){
            // alert('display Add couponredeem form');
            // $emit('newredeemcouponclicked',$event)
            ...
            <div class="col-xl-4 order-1 order-xl-2 m--align-right">
                <a href="#" v-on:click="displayForm()" class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
                    <span>
                        ...
                        <span> Redeem Coupon Serials</span>
                    </span>
                </a>
...
Vue.component('redeemcoupon-list-component', {
    props: ['coupon_code'],
    data: function() {
        return {
            subheader:{
                title: 'redeemcoupon',
                items :[
                    {id:1, link:'/loyalty/redeemcoupon', icon:'la la-home', name:'' },
    ...
    template: `
    <div class="m-grid__item m-content-couponserial-list" id="m-redeemcoupon-list" >
        <div class="m-content">
            <div class="m-portlet m-portlet--mobile">
                <redeemcoupon-table-header-component></redeemcoupon-table-header-component>
                <div class="m-portlet__body">
                    <!--begin: Search Form -->
                    <redeemcoupon-table-search-component :coupon_code="coupon_code"
                    ...
                    ></redeemcoupon-table-search-component>
                    <!--end: Search Form -->

                    <!--begin: Datatable -->
                    <div class="m_datatable_couponserial_redeem" id="couponserial_redeem_data"></div>
                    <!--end: Datatable -->
                </div>
            </div>
        </div>
