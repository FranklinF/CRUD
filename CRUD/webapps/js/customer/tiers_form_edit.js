Vue.component('tiers-form-edit-header', {
    props:['isformvalid'],
    computed: {
        isDisabled() {
    ...
    <div class="m-portlet__head">
        ...
        <div class="m-portlet__head-wrapper">
            ...
            <div class="m-portlet__head-tools">
                ...
                <button id="tier_update_submit" v-on:click="$emit('tierformsave',$event)" type="button" class="btn btn-primary m-btn m-btn--custom" :disabled="isDisabled">Save</button>
            </div>
        </div>
    </div>
    `
...
Vue.component('tiers-form-edit-component', {
    props:['primaryinput', 'tierid'],
    data: function() {
        return {
            tier: {
                tier_id: '',
    ...
    watch:{
        ...
        'tierid': function() {
            ...
            this.getTier(this.tierid);
        },
        
    },
    created: function () {
        console.log('Edit form created')
        console.log('TierId is: ' + this.tierid);
    ...
    methods: {
        ...
        getTier: function(tierid) {
            ...
            var vm = this;
            axios.get('loyalty/tiers/'+tierid)
            .then((response) => {
                var vm = this;
                console.log("Response ", response.data);
                let data = response.data;
                vm.tier.tier_id = data.tier_id;
                vm.tier.tier_name = data.tier_name;
                vm.tier.tier_description = data.tier_description;
                vm.tier.sequence = data.sequence;
        ...
        submitEditForm:function(){
            var vm = this;
            var btn = $('#tier_update_submit');
            var form = $('#m_form_tier_edit');
            ...
            axios.put(`/loyalty/tiers/`+ vm.tier.tier_id, {
                'tier_id': vm.tier.tier_id,
                ...
                this.$emit('showtoast',{'msg':'Tier has been updated','type':'success','event':this.$event})
            ...
            .catch(e => {
                ...
                // vm.showErrorMsg(form, 'danger', 'Tier Update failed !! ' + e.response.data.error_msg);
            })
        },
        cancelForm:function(){
            this.resetData();
    ...
    template: `
    <div class="m-grid__item m-content-tier-form d-none" id="m-tier-form-edit" >
        <div class="m-content">
            <div class="row">
                <div class="col-lg-12">
                    <!--begin::Portlet-->
                    <div class="m-portlet m-portlet--last m-portlet--head-lg m-portlet--responsive-mobile" id="main_portlet">
                    <tiers-form-edit-header v-bind:isformvalid="isValidForm"
                            @tierformcancel="cancelForm()"
                            @tierformsave="submitEditForm()"
                    ></tiers-form-edit-header>
                        <div class="m-portlet__body">
                            <form class="m-form m-form--fit m-form--label-align-right" id="m_form_tier_edit">
                                <!--begin: Form Body -->
                                <div class="m-portlet__body">
                                    <div class="row">
                                        <div class="col-xl-8">
                                            <div class="m-form__section m-form__section--first">
                                                ...
                                                <div class="form-group m-form__group row">
                                                    ...
                                                    <div class="col-xl-9 col-lg-9">
                                                        <div class="input-group m-input-icon m-input-icon--left m-input-icon--right">                                                            
                                                            <input v-model="tier.tier_name" v-on:input="tier.tier_name = $event.target.value.toUpperCase()" type="text" name="name"  id="tier_name" class="form-control m-input" placeholder="" value="">                                                                    
                                                        </div>
                                               ...
                                               <!-- <div class="form-group m-form__group row">
                                                    ...
                                                    <div class="col-xl-9 col-lg-9">
                                                        <div class="input-group m-input-icon m-input-icon--left m-input-icon--right">                                                            
                                                            <input v-model="tier.sequence" type="number" name="name"  id="sequence" class="form-control m-input" placeholder="" value="">                                                                    
                                                        </div>
                                                    ...
                                                    <div class="col-xl-9 col-lg-9">
                                                        <div class="input-group m-input-icon m-input-icon--left m-input-icon--right">                                                             
                                                            <span class="m-switch m-switch--outline m-switch--icon m-switch--primary">
                                                                <label>
                                                                <input type="checkbox" v-model="tier.status" v-on:change="changeStatus($event)"  name="">
                                                                <span></span>
                                                                </label>
                                                            </span>
                                                        </div>
