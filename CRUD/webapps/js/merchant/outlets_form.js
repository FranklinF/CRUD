Vue.component('outlets-form-header', {
    props:['isformvalid'],
    computed: {
        isDisabled() {
    ...
    <div class="m-portlet__head">
        ...
        <div class="m-portlet__head-wrapper">
            ...
            <div class="m-portlet__head-tools">
                ...
                <button id="outlet_submit" v-on:click="$emit('outletformsave',$event)" type="button" class="btn btn-primary m-btn m-btn--custom" :disabled="isDisabled">Save</button>
            </div>
        </div>
    </div>
    `
...
Vue.component('outlets-form-component', {
    props:['primaryinput'],
    data: function() {
        return {
            outlet: {
    ...
    methods: {
        ...
        submitForm:function(){
            var vm = this;
            var btn = $('#outlet_submit');
            var form = $('#m_form_outlet_new');
            form.validate({
                rules: {
                    outlet_name: {
                        required: true,
            ...
            var outletData = { 
                outlet_id: vm.outlet.outlet_name,                              
            ...
            axios.post(`/loyalty/outlets`, outletData).then(response => {
                console.log(response.data.status);
                btn.removeClass('m-loader m-loader--right m-loader--light').attr('disabled', false);
                this.$emit('showtoast',{'msg':'Outlet has been added','type':'success','event':this.$event})
                this.resetData();
        ...
        openTime: function(time) {
            ...
            this.outlet.outlet_open_time = $('#m_timepicker_open').val();
            
        },
        closeTime: function(time) {
            this.outlet.outlet_close_time = $('#m_timepicker_close').val();
        }
    },
    template: `
    <div class="m-grid__item m-content-outlet-form d-none" id="m-outlet-form" >
        <div class="m-content">
            <div class="row">
                <div class="col-lg-12">
                    <!--begin::Portlet-->
                    <div class="m-portlet m-portlet--last m-portlet--head-lg m-portlet--responsive-mobile" id="main_portlet">
                    <outlets-form-header v-bind:isformvalid="isValidForm"
                            @outletformcancel="cancelForm()"
                            @outletformsave="submitForm()"
                    ></outlets-form-header>
                        <div class="m-portlet__body">
                            <form class="m-form m-form--fit m-form--label-align-right" id="m_form_outlet_new">
                                <!--begin: Form Body -->
                                <div class="m-portlet__body">
                                    <div class="row">
                                        <div class="col-xl-8">
                                            <div class="m-form__section m-form__section--first">
                                                ...
                                                <div class="form-group m-form__group row">
                                                    ...
                                                    <div class="col-lg-4 col-md-9 col-sm-12">
                                                        <input class="form-control opentime"  name="outlet_open_time"  v-model="outlet.outlet_open_time" id="m_timepicker_open" readonly placeholder="Open time" type="text"/>
                                                    </div>
                                                    <div class="col-lg-4 col-md-9 col-sm-12">
                                                        <input class="form-control"  name="outlet_close_time" v-model="outlet.outlet_close_time" id="m_timepicker_close" readonly placeholder="Close time" type="text"/>
                                                    </div>
                                                </div>                                              
                                                <div class="form-group m-form__group row">
    ...
    mounted: function() {
        ...
        var vm = this;
        $('#m_timepicker_open').timepicker({
            defaultTime: '',
            showInputs: false
        }).on('change', function(){
             vm.outlet.outlet_open_time = $(this).val();
          });
        $('#m_timepicker_close').timepicker({
            defaultTime: '',
            showInputs: false
        }).on('change', function(){
        ...
        this.autocomplete.addListener('place_changed', () => {
            ...
            // console.log("country ", ac[5])
            console.log(`The user picked   ${JSON.stringify(ac)} ${place}  with the coordinates ${lat}, ${lon}`);
          });
      }
})