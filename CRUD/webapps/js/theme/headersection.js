Vue.component('theme-brand-component', {
	data: function() {
		return {
			imageurl: '',
			business_name: '',
		...
		getToken: function() {
            ...
            .then((response) => {
				...
				if(tokenData.length > 0) {
                    ...
                    vm.brandimg = tokenData[0].imageurl;
    ...
    <div class="m-stack__item m-brand  m-brand--skin-dark ">
        <div class="m-stack m-stack--ver m-stack--general">
            <div class="m-stack__item_hd m-stack__item--middle m-brand__logo">
                <a href="/dashboard" class="m-stack__icon">
                    <img alt="" :src="brandimg" width="40px" class='m-brand__logo_sidebar'/>
                    <span class="m-brand__logo_txt" data-container="body" data-toggle="m-tooltip" data-placement="right" :title="business_name"> {{business_name}}</span>
                </a>
            </div>
...
Vue.component('theme-horizontal-menu-component', {
    template: `
...
Vue.component('theme-topbar-component', {
    data: function() {
        return {
            imageurl: '',
            name: '',
		...
		getProfile: function() {
            ...
            if(token == null) {
                ...
                .then((response) => {
                    ...
                    sessionStorage.setItem("timezone",response.data.time_zone);
                    vm.imageurl= response.data.imageurl;
                    vm.name = response.data.business_name;
                    vm.email = respoanse.data.email;
                })
                .catch((error) => {
        ...
        <div class="m-stack__item m-topbar__nav-wrapper">
            <ul class="m-topbar__nav m-nav m-nav--inline">
                ...
                <li class="m-nav__item m-topbar__user-profile m-topbar__user-profile--img  m-dropdown m-dropdown--medium m-dropdown--arrow m-dropdown--header-bg-fill m-dropdown--align-right m-dropdown--mobile-full-width m-dropdown--skin-light"
                    m-dropdown-toggle="click">
                    <a href="#" class="m-nav__link m-dropdown__toggle">
                        <span class="m-topbar__username" style="color: #000">{{name}}</span>&nbsp;
                        <span class="m-topbar__userpic">
                            <img :src="imageurl" onError='this.src="/assets/app/media/img/users/profile_img.png"' class="m--img-rounded m--marginless" alt="" />
                        </span>                        
                    </a>
                    <div class="m-dropdown__wrapper">
                        <span class="m-dropdown__arrow m-dropdown__arrow--right m-dropdown__arrow--adjust"></span>
                                ...
                                <div class="m-dropdown__content">
                                    <ul class="m-nav m-nav--skin-light">
                                      ...
                                      <!--  <li class="m-nav__item">
                                        ...
                                        <li class="m-nav__item">
                                            <a href="#" v-on:click="logout($event)" class="btn m-btn--pill    btn-secondary m-btn m-btn--custom m-btn--label-brand m-btn--bolder">Logout</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
    ...
    `,
    mounted: function() {
        this.$on('profileupdate', function() {
            alert("Profile Update from settings");
        })
    }
})

Vue.component('theme-header-component', {
    template: `
    <header id="m_header" class="m-grid__item    m-header " m-minimize-offset="200" m-minimize-mobile-offset="200">
        <div class="m-container m-container--fluid m-container--full-height">
            <div class="m-stack m-stack--ver m-stack--desktop">
                ...
                <!-- BEGIN: Brand -->
                <theme-brand-component></theme-brand-component>
                <!-- END: Brand -->

                <div class="m-stack__item m-stack__item--fluid m-header-head" id="m_header_nav">
                    <!-- BEGIN: Topbar -->
                    <theme-topbar-component></theme-topbar-component>
                    <!-- END: Topbar -->
                </div>
            </div>
        </div>
